...
#external parameters
ncp_params.folderName = "phaseRet_DM"
...
for i in range(ncp_params.N):
	itr, itrSoln = ncp_funcs.alg_DM(ncp_funcs.projFour, ncp_funcs.projSupp, ncp_funcs.r_projFour, ncp_funcs.r_projSupp, itr, ncp_params.beta, conFour, conSupp)
