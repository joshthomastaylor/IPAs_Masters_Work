...
#external parameters
ncp_params.folderName = "ampRet_DM"
...
for i in range(ncp_params.N):
	itr, itrSoln = ncp_funcs.alg_DM_amp(ncp_funcs.projFourAmp, ncp_funcs.projSupp, ncp_funcs.r_projFourAmp, ncp_funcs.r_projSupp, itr, ncp_params.beta, conFour, conSupp, conDC)
...
suppIndex = ncp_params.suppSelect[::2]
