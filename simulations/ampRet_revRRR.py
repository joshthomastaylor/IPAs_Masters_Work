...
#designate algorithm name
ncp_params.folderName = "ampRet_revRRR"
...
for i in range(ncp_params.N):
	itr, itrSoln = ncp_funcs.alg_revRRR_amp(ncp_funcs.projFourAmp, ncp_funcs.projSupp, itr, ncp_params.beta, conFour, conSupp, conDC)
