...
#external parameters
ncp_params.folderName = "imagRet_DM"
...
for i in range(ncp_params.N):
	itr, itrSoln = ncp_funcs.alg_DM(ncp_funcs.projFourImag, ncp_funcs.projSupp, ncp_funcs.r_projFourImag, ncp_funcs.r_projSupp, itr, ncp_params.beta, conFour, conSupp)
